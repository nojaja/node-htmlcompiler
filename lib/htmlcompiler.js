...
(function (global, factory) {
  ...
  var ReactComponentBuilder = function (_Builder) {
    ...
    function ReactComponentBuilder(options) {
      ...
      _this.elementNames = options.elementNames || [];
  ...
  var WebComponentParser = function (_Builder) {
    ...
    **/
    function WebComponentParser(options) {
      ...
      var self = _this;
      _this.builder = options.builder; //webComponent��build�ɗ��p�����r���_�[�����`���܂��B
      _this.elementNames = [];
      _this.elements = {};
      _this.components = {};
      return _this;
  ...
  var Compiler = function () {
    ...
    _createClass(Compiler, [{
      ...
      value: function compile(src) {
        ...
        return this.createNodes(src, { nodes: { length: 1, pos: 1 }, depth: 0 });
      }
    }]);
...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['./htmlcompiler.babel.js', './Builder.babel.js', './HtmlBuilder.babel.js', './CSSBuilder.babel.js', './IncrementalDomBuilder.babel.js', './ReactComponentBuilder.babel.js', './WebComponentParser.babel.js'], factory);
  } else if (typeof exports !== "undefined") {
    factory(require('./htmlcompiler.babel.js'), require('./Builder.babel.js'), require('./HtmlBuilder.babel.js'), require('./CSSBuilder.babel.js'), require('./IncrementalDomBuilder.babel.js'), require('./ReactComponentBuilder.babel.js'), require('./WebComponentParser.babel.js'));
  } else {
    var mod = {
      exports: {}
    };
    factory(global.htmlcompilerBabel, global.BuilderBabel, global.HtmlBuilderBabel, global.CSSBuilderBabel, global.IncrementalDomBuilderBabel, global.ReactComponentBuilderBabel, global.WebComponentParserBabel);
    global.indexBabel = mod.exports;
  }
})(this, function (_htmlcompilerBabel, _BuilderBabel, _HtmlBuilderBabel, _CSSBuilderBabel, _IncrementalDomBuilderBabel, _ReactComponentBuilderBabel, _WebComponentParserBabel) {
  'use strict';
...
},{"./Builder.babel.js":1,"./CSSBuilder.babel.js":2,"./HtmlBuilder.babel.js":3,"./IncrementalDomBuilder.babel.js":4,"./ReactComponentBuilder.babel.js":5,"./WebComponentParser.babel.js":6,"./htmlcompiler.babel.js":7}]},{},[8]);
