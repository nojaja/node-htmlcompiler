...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['./htmlcompiler.babel.js'], factory);
  } else if (typeof exports !== "undefined") {
    factory(require('./htmlcompiler.babel.js'));
  } else {
    var mod = {
      exports: {}
    };
    factory(global.htmlcompilerBabel);
    global.indexBabel = mod.exports;
  }
})(this, function (_htmlcompilerBabel) {
  'use strict';
